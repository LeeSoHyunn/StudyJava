 ...
 *  - Person p1, Pernson p2가 있는 경우에 p1.getName(), p2.getName()은 다른 값을 가질수 있음
 *  - static이 변수 앞에 붙으면 모든 인스턴스에 대해서 공유가 됩니다. 이때 변수는 인스턴스 변수가 아닌 클래스 단위로 바뀌게 되고,
 *    이 때문에 static이 붙은 멤버변수를 클래스변수라고 합니다.
 ...
 *     > 반대로 static 붙지 않는 메서드안에서는 static 멤버를 사용할 수 잇음
 *     
 *     - 주로 모든 인스턴스가 공통된 변수값을 가져야하는 경우가 있는데 이때 static변수를 사용합니다
 *      static 변수와 관련된 작업을 하거나 어떤 인스턴슨 변수도 사용하지 않고, 매개변수로만 작업을
...
public class C06_static {  //public 접근제한자
	...
	public static void main(String[] args) {
		...
		System.out.println("static b: "+c2.b); //클래스에서 공유되는//
