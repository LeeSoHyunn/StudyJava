 ...
 * # 인터페이스 
 ...
 인터페이스 선언 
  ...
  interface InterfaceName [extends <SuperInterface부모인터페이스>,<SupterInterface>....] {
  		interfaceBody
  }
 ...
 예) 인터페이스 정의
  ...
  - 인터페이스 내에 변수(상수)는 항상 public static final이며 이 또한 생략이 가능합니다. 
  - 인터페이스는 구현하면 다중 상속과 같은 효과를 낼 수 있습니다.  //여러개의 인터페이스 구현가능
  (상속을 여러개 받으면 어느 부모의 멤버를 상속받아야할지 결정할 수 없지만, 인터페이스는 클래스의 골격에 해당하기 때문에 여러개를 구현할 수 있습니다.)
