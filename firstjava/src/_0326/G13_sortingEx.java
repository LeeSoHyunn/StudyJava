...
public class G13_sortingEx {
	...
	일반적인 객체를 정렬하기 위해서 Comparable 인터페이스를 구현한 클래스 객체만 정렬 가능합니다.
	...
	*/
	...
	public static void main(String[] args) {
		...
		//(추상메서드가 하나만 있어서) 함수적 인터페이스로 람다식으로 변형가능
		System.out.println("람다표현식을 이용해서 둘레순으로 정렬");
		list2.stream().sorted((a,b) -> (int)(a.length() - b.length())) //b.length - a.length()
				      .forEach(System.out::println);
	}
