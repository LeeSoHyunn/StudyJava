...
public class B02_ifExample2 {
	...
	public static void main(String[] args) {
		// 난수 생성 : 임의 값(Random)
		//1. Math.random() : 0~1 미만의 임의 값을 출력(출력값 double 타입)
		...
		//  - nextInt(int) : 0부터 생성자에 들어간 숫자 -1까지 int형 난수발생
...
*/
		...
		//if ~ else문 : if조건문이 true이면 if 종속 실행문을 그렇지 않으면 else의 실행문을 동작!
		
		//정수 난수 발생(0 ~99 사이의 난수 발생)
		int jumsu = (int)(Math.random()*100); //랜덤은 더블 타입이기때문에 강제 형변환
