 ...
 *  주석은 코드를 설명하거나 기술할때 사용
 *  새 프로젝트 생성
 *  file -> new -> java project -> 프로젝트 이름 입력
 *  
 *  클래스 파일 생성
 *  src(소스폴더) -> 우클릭 -> new -> class -> 클래스 이름 지정
 */
 ...
 *      -플랫폼 독립적(아키텍처 중립적) --자바를 사용하는 가장큰이유
 *      ex.컴퓨터가 맥이든 윈도우든 따지지않고 어디서든 동작
...
//Java 에서 public class의 이름은 항상 파일명과 같아야함
// 빨간줄로 오류가 표시되면 F2버튼 : 에러에 대한 정보및 해결책 제공
public class A01_Helloworld {

	//main() 메서드 : 프로그램의 시작위치
	public static void main(String[] args) { // {} 블럭 중괄호 -- 블록은 여러 명령어가 묶여있는 부분
		
		// ; 세미콜론 : 한 명령어의 끝을 알림 
		// System.out.println() 메서드 : 콘솔에 ()안에 있는 입력 내용을 출력하는 기능의 메서드
		System.out.println("Hello, world!");
		
		System.out.println("안녕하세요"); // --> 자동완성 sysout + ctrl스페이스
		System.out.println("1234");
		System.out.println("19.2323");
		// "" 사이에 있는 내용은 문자열
		
		System.out.println("1234"); //숫자 : 정수형
		System.out.println(); //아무것도 입력 X -> 줄바꿈
